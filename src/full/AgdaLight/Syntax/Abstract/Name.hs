...
-}
module AgdaLight.Syntax.Abstract.Name
  ( module AgdaLight.Syntax.Abstract.Name
  , IsNoName(..)
  ) where
...
import AgdaLight.Syntax.Common
import {-# SOURCE #-} AgdaLight.Syntax.Fixity
import AgdaLight.Syntax.Concrete.Name (IsNoName(..), NumHoles(..))
import qualified AgdaLight.Syntax.Concrete.Name as C

import AgdaLight.Utils.List
import AgdaLight.Utils.Maybe
import AgdaLight.Utils.Monad
import AgdaLight.Utils.Pretty
import AgdaLight.Utils.Size
import AgdaLight.Utils.Suffix
