...
-}
module AgdaLight.Syntax.Common where
...
import AgdaLight.Utils.Functor
import AgdaLight.Utils.Pretty hiding ((<>))
...
--   See "AgdaLight.TypeChecking.Irrelevance".
data Relevance
