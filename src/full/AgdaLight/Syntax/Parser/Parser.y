...
{-| The parser is generated by Happy (<http://www.haskell.org/happy>).
 ...
 -
 -}
module AgdaLight.Syntax.Parser.Parser (
      moduleParser
    , moduleNameParser
    , exprParser
    , exprWhereParser
...
import AgdaLight.Syntax.Position hiding (tests)
import AgdaLight.Syntax.Parser.Monad
import AgdaLight.Syntax.Parser.Lexer
import AgdaLight.Syntax.Parser.Tokens
import AgdaLight.Syntax.Concrete as C
import AgdaLight.Syntax.Concrete.Pretty ()
import AgdaLight.Syntax.Common
import AgdaLight.Syntax.Fixity
import AgdaLight.Syntax.Notation
import AgdaLight.Syntax.Literal

import AgdaLight.TypeChecking.Positivity.Occurrence hiding (tests)

import AgdaLight.Utils.Either hiding (tests)
import AgdaLight.Utils.Hash
import AgdaLight.Utils.List ( spanJust, chopWhen )
import AgdaLight.Utils.Monad
import AgdaLight.Utils.Pretty
import AgdaLight.Utils.Singleton
