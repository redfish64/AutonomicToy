...
module AgdaLight.Syntax.Parser.Monad
    ( -- * The parser monad
      Parser
    , ParseResult(..)
    , ParseState(..)
...
import AgdaLight.Utils.Except ( MonadError(catchError, throwError) )
#if !(MIN_VERSION_mtl(2,2,1))
import AgdaLight.Utils.Except ( Error(noMsg) )
#endif

import AgdaLight.Utils.FileName
import qualified AgdaLight.Utils.IO.UTF8 as UTF8
import qualified AgdaLight.Utils.Maybe.Strict as Strict
