...
-}
module AgdaLight.Syntax.Parser.LexActions
    ( -- * Main function
      lexToken
      -- * Lex actions
      -- ** General actions
...
import AgdaLight.Utils.Lens
import AgdaLight.Utils.List
import AgdaLight.Utils.Tuple
...
'AgdaLight.Syntax.Parser.Lexer.alexScanUser'. This is the main lexing function
where all the work happens. The function 'AgdaLight.Syntax.Parser.Lexer.lexer',
...
-- | Executed for layout keywords. Enters the 'AgdaLight.Syntax.Parser.Lexer.layout'
