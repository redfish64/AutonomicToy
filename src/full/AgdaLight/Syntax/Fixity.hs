...
import qualified AgdaLight.Syntax.Abstract.Name as A
import AgdaLight.Syntax.Concrete.Name
import AgdaLight.Syntax.Notation
...
-- For @instance Pretty Fixity@, see AgdaLight.Syntax.Concrete.Pretty
